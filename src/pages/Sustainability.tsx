    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <section className="relative py-24 md:py-32 overflow-hidden">
          ...
          />
          {/* Vignette overlay to darken the center where text sits */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.65)_0%,transparent_70%)]" />
        ...
        <div className="px-6 md:px-8 py-12">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-12 mb-12">
            ...
            <div className="flex flex-wrap gap-3 lg:justify-end">
              ...
              <a href="#" className="w-11 h-11 rounded border border-border flex items-center justify-center hover:bg-muted transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.387v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="#" className="w-11 h-11 rounded border border-border flex items-center justify-center hover:bg-muted transition-colors">
