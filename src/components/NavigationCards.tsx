...
import heroCardFaceitOW from "@/assets/hero-card-faceit-ow.png";
...
const HeroCard = ({ headline, subtitle, ctaText, ctaLink, backgroundImage }: HeroCardProps) => {
  return (
    <div className="relative w-full h-[400px] md:h-[550px] rounded-lg overflow-hidden bg-carbon-800">
      {/* Background image */}
      <img 
        src={backgroundImage} 
        alt="" 
  ...
  const secondaryCards: HeroCardProps[] = [
    {
      ...
      ctaText: "View More",
      ctaLink: "/",
      backgroundImage: heroCardFaceitOW
    },
    {
